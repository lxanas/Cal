...
public class CalaFrame extends JFrame {
    ...
    public void initListener() {
        ...
        this.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e) {
                ...
                int n = JOptionPane.showConfirmDialog(CalaFrame.this, "确认退出吗？",
    ...
    public void basementType() {
        ...
        try {
            ...
            text2.setBounds(10, 10, 195, 25);
            text2.setHorizontalAlignment(JTextField.RIGHT);
            CalaFrame.this.remove(panel);
            CalaFrame.this.remove(panel2);
            CalaFrame.this.add(panel3);
            CalaFrame.this.add(panel1);
        } catch (Exception e) {
